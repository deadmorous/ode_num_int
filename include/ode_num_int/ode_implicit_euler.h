// ode_implicit_euler.h

#ifndef _ODE_IMPLICIT_EULER_H_
#define _ODE_IMPLICIT_EULER_H_
...
class OdeSolverImplicitEuler :
    ...
    public:
        ...
        OdeSolverImplicitEuler() :
            ...
            m_predictorSteps( 1 ),
            m_mapping4Newton( std::make_shared< OdeTimeStepperEuler<VD> >() )
            {
        ...
        void setParameters( const Parameters & parameters )
            ...
            OptionalParameters::maybeSetParameter(
                        parameters, "alpha",
                        std::bind( &OdeTimeStepperEuler<VD>::setImplicitnessParameter, m_mapping4Newton.get(), std::placeholders::_1 ) );
    ...
    private:
        ...
        std::shared_ptr< OdeTimeStepperEuler<VD> > m_mapping4Newton;
        V m_buf;
        V m_eqnbuf;
    };
