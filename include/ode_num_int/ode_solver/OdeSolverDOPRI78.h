...
#ifndef _ODESOLVER_ODESOLVERDOPRI78_H_AB0B81B0_CF3E_424f_9766_BA04D388199F_
#define _ODESOLVER_ODESOLVERDOPRI78_H_AB0B81B0_CF3E_424f_9766_BA04D388199F_
...
template< class VD >
class OdeSolverDOPRI78 :
    public OdeSolverExplicitEmbeddedRK<VD>,
    public FactoryMixin< OdeSolverDOPRI78<VD>, OdeSolver<VD> >
    {
    public:
        ...
        OdeSolverDOPRI78() :
            OdeSolverExplicitEmbeddedRK<VD>(
                // https://www.mathworks.com/matlabcentral/mlc-downloads/downloads/submissions/3616/versions/1/previews/ode87.m/index.html
                typename ExplicitRKHelper<VD>::Coefficients({
                  ...
                  -1028468189./846180014, 0, 0, 8478235783./508512852, 1311729495./1432422823, -10304129995./1701304382, -48777925059./3047939560, 15336726248./1032824649, -45442868181./3398467696, 3065993473./597172653,
                   ...
                   // c
                   1./18, 1./12, 1./8, 5./16, 3./8, 59./400, 93./200, 5490023248./9719169821, 13./20, 1201146811./1299019798, 1, 1 },
                   -1 ),
                8, 7 )
            {}
    };
...
% nstep;
*/
#endif // _ODESOLVER_ODESOLVERDOPRI78_H_AB0B81B0_CF3E_424f_9766_BA04D388199F_
